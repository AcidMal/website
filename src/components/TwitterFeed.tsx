  ...
  return (
    <div>
      ...
      <a
        ...
        className="inline-block mt-4 text-purple-400 hover:ease-in-out hover:duration-300
        hover:text-purple-600 dark:text-purple-400 hover:ease-in-out hover:duration-300 
